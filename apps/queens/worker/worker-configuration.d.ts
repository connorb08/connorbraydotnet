/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 582d9f64872d20d036520344e57723b2)
// Runtime types generated with workerd@1.20250709.0 2025-05-06 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		LOG_LEVEL: "error";
		STORAGE: DurableObjectNamespace<import("./index").Storage>;
		BROWSER: Fetcher;
	}
}
