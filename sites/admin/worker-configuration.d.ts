/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.json -c /workspaces/connorbraydotnet/services/database/wrangler.json -c /workspaces/connorbraydotnet/services/linkedin-games/queens/wrangler.json` (hash: de1d92daf5ef69cc72cf0c9f7d1c4a19)
// Runtime types generated with workerd@1.20250709.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		CONTENT_MANAGER: Service /* entrypoint MainEntrypoint from content-manager */;
		QUEENS: Service<import("../../services/linkedin-games/queens/worker/index").Entrypoint>;
		API: Service /* entrypoint MainEntrypoint from next-api */;
		DATABASE: Service<import("../../services/database/src/index").Entrypoint>;
	}
}
