...
export const projectsData: ExtendedProject[] = [
	...
	},
	{
		slug: "portfolio",
		name: "connorbray.net",
		description: "Personal portfolio & interactive resume built with a modern TypeScript stack and deployed globally at the edge. Focused on performance, accessibility, DX, and a maintainable design system.",
		about: [
			"React + TypeScript app bootstrapped with Vite for fast local feedback loops",
			...
			"Structured data & meta generation for SEO and rich link previews",
		...
		challenges: [
			"Balance visual polish and animation with Core Web Vitals targets",
			"Create a scalable styling approach without over‑engineering",
			"Ship globally fast on a budget (no traditional server)",
			"Keep content (projects, metadata) easy to evolve without a CMS",
			"Maintain accessibility while iterating on design details",
		],
		solutions: [
			"Used transform/opacity animations with reduced-motion fallbacks and GPU-friendly patterns",
			"Implemented layered SCSS architecture: tokens -> mixins -> component modules",
			"Deployed to Cloudflare Workers for edge rendering and low latency worldwide",
			"Centralized project/resume data in typed JSON/TS modules for frictionless edits",
			"Added linting + manual audits (axe, Lighthouse) to catch regressions early",
		],
		features: [
			...
			"SEO + structured data (Open Graph, JSON-LD, canonical links)",
		],
	},
	{
		slug: "resume",
		name: "HTML Resume",
		description: "Single‑source, standards-based resume rendered as semantic HTML/CSS with print/PDF fidelity and zero runtime dependencies.",
		about: [
			"Hand-authored semantic HTML structure (sections, lists, microdata-ready)",
			"Tokenized spacing & typography scale for consistent rhythm across breakpoints",
			"Print stylesheet tuned for 1–2 page PDF export (controlled widows/orphans & page breaks)",
		...
		solutions: [
			"Implemented percentage + rem-based spacing scale with line-height alignment",
		...
		features: [
			...
			"Dark / light aware palette with print-safe fallback",
