...
function validate10(
	...
	if (data && typeof data === "object" && !Array.isArray(data)) {
		...
		if (data.about !== undefined) {
			...
			if (data1 && typeof data1 === "object" && !Array.isArray(data1)) {
				...
				if (data1.summary !== undefined) {
					const data2 = data1.summary;
					if (typeof data2 !== "string" && data2 !== null) {
						const err11 = {
							instancePath: `${instancePath}/about/summary`,
							schemaPath: "#/properties/about/properties/summary/type",
							keyword: "type",
							params: { type: "string" },
							message: "must be string",
						};
				...
				if (data1.phoneNumber !== undefined) {
					const data3 = data1.phoneNumber;
					if (typeof data3 === "string") {
						if (typeof data3 === "string" && data3.trim() === "") {
							const err12 = {
				...
				if (data1.emailAddress !== undefined) {
					const data4 = data1.emailAddress;
				...
				if (data1.technologies !== undefined) {
					const data8 = data1.technologies;
		...
		if (data.education !== undefined) {
			const data12 = data.education;
			if (Array.isArray(data12)) {
				const len3 = data12.length;
				for (let i3 = 0; i3 < len3; i3++) {
					const data13 = data12[i3];
					if (data13 && typeof data13 === "object" && !Array.isArray(data13)) {
						if (data13.school === undefined) {
							const err24 = {
						...
						if (data13.school !== undefined) {
							if (typeof data13.school !== "string") {
								const err27 = {
						...
						if (data13.degree !== undefined) {
							if (typeof data13.degree !== "string") {
								const err28 = {
						...
						if (data13.location !== undefined) {
							const data16 = data13.location;
						...
						if (data13.startDate !== undefined) {
							const data17 = data13.startDate;
						...
						if (data13.endDate !== undefined) {
							const data18 = data13.endDate;
		...
		if (data.career !== undefined) {
			const data21 = data.career;
			if (Array.isArray(data21)) {
				const len5 = data21.length;
				for (let i5 = 0; i5 < len5; i5++) {
					const data22 = data21[i5];
					if (data22 && typeof data22 === "object" && !Array.isArray(data22)) {
						if (data22.company === undefined) {
							const err36 = {
						...
						if (data22.company !== undefined) {
							if (typeof data22.company !== "string") {
								const err41 = {
						...
						if (data22.location !== undefined) {
							if (typeof data22.location !== "string") {
								const err43 = {
						...
						if (data22.startDate !== undefined) {
							if (typeof data22.startDate !== "string") {
								const err44 = {
						...
						if (data22.endDate !== undefined) {
							const data29 = data22.endDate;
		...
		if (data.projects !== undefined) {
			const data30 = data.projects;
			if (Array.isArray(data30)) {
				const len7 = data30.length;
				for (let i7 = 0; i7 < len7; i7++) {
					const data31 = data30[i7];
					if (data31 && typeof data31 === "object" && !Array.isArray(data31)) {
						...
						if (data31.about !== undefined) {
							const data34 = data31.about;
							if (Array.isArray(data34)) {
								const len8 = data34.length;
								for (let i8 = 0; i8 < len8; i8++) {
									if (typeof data34[i8] !== "string") {
										const err54 = {
											instancePath:
